...
def main_worker(gpu, ngpus_per_node, args):
    ...
    pretrained_weights_path = '/home/ak362297/TransGeo2022/result_randomNoiseSeveritylvl2/model_best.pth.tar'
    ...
    if args.resume:
        if os.path.isfile(args.resume):
            ...
            if args.gpu is None:
                ...
                checkpoint = torch.load(pretrained_weights_path, map_location=loc)
            if not args.crop:
