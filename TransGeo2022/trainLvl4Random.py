...
import numpy as np
from dataset.CVUSA_Noise4Random import CVUSA_Noise4Random
...
parser.add_argument('--noiseIndex', type=int, help='Index of the noise type')
...
def accuracy(query_features, reference_features, query_labels, noise_name, topk=[1,5,10]):
    ...
    with open('trainNoiselvl4RandomEvaluationValues.txt', 'a') as file:
