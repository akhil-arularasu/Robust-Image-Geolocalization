...
class CVUSA_Noise2(torch.utils.data.Dataset):
    ...
    def __init__(self, mode = '', root = '/home/c3-0/parthpk/CVUSA/', query_root = '/home/ak362297/TransGeo2022/FINALCVUSANoiseSeverity4/',same_area=True, print_bool=False, polar = '', args=None, noiseName='Gaussian Noise'): #CV-dataset
