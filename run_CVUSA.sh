...
python -u trainTemp.py --lr 0.00001 --batch-size 32 --dist-url 'tcp://localhost:10002' --multiprocessing-distributed --world-size 1 --rank 0  --epochs 100 --save_path ./result_randomNoiseSeveritylvl2 --op sam --wd 0.03 --mining --dataset cvusa --cos --dim 1000 --asam --rho 2.5
#python -u train.py --lr 0.00001 --batch-size 32 --dist-url 'tcp://localhost:10002' --multiprocessing-distributed --world-size 1 --rank 0  --epochs 100 --resume ./PretrainedModel/result/model_best.pth.tar --save_path ./result_all2 --op sam --wd 0.03 --mining --dataset cvusa --cos --dim 1000 --asam --rho 2.5 --sat_res 320 --crop --evaluate
